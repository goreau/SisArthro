                            ...
                            <div class="columns">
                                ...
                                <div class="field column is-2">
                                    ...
                                    <div class="control has-icons-left has-icons-right">
                                        <label class="radio">
                                            <input type="radio" name="registro" value="1" v-model="notifica.registro" />
                                            1 - Não
                                        </label>
                                        <label class="radio">
                                            <input type="radio" name="registro" value="2" v-model="notifica.registro" />
                                            2 - Sim
                                        </label>
                                    </div>
