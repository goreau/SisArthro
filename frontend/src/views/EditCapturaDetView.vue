...
export default {
  ...
  methods: {
    edit() {
      ...
      capturaService.editDet(this.captura_det).then(
        (response) => {
    ...
    loadData() {
      ...
      capturaService.getCapturaDet(this.captura_det.id_captura_det).then(
        (response) => {
          ...
          this.captura_det.hora_inicio = data.hora_iniciol; 
