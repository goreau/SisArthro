...
export default {
    ...
    mounted() {
        ...
        this.columns = [
            ...
            { title: "Quarteirão", field: "quadra", minWidth: 200, responsive:3, },
            { title: "Tipo", field: "tipo", minWidth: 150, responsive:2, },
            { title: "Número", field: "numero", minWidth: 200, responsive:2, },
            {
            ...
            },
            {
                ...
                formatter: (cell, formatterParams) => {
                    ...
                    btEdit.addEventListener("click", () => {
                        this.$router.push(`/editInquerito/${row.id_inquerito}`);
                    });
