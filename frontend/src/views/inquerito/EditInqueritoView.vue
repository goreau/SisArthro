                                ...
                                <div class="field column is-4">
                                    ...
                                    <div class="control">
                                        <CmbMunicipio :id_prop="currentUser.id"
                                            @selMun="inquerito.id_municipio = $event" :sel="inquerito.id_municipio"
...
export default {
    ...
    methods: {
        ...
        loadData() {
            ...
            inqueritoService.getInquerito(this.inquerito.id_inquerito).then(
                async (response) => {
                    let data = response.data;
                    this.inquerito.id_municipio = data.id_municipio;
                    ...
                    this.inquerito.numero = data.numero;
                    this.inquerito.id_tipo = data.id_tipo;
                    this.inquerito.encoleiramento = data.encoleiramento;
        ...
        edit() {
            ...
            if (!this.v$.$error) {
                ...
                inqueritoService.edit(this.inquerito)
                    .then(
                        (response) => {
                            this.showMessage = true;
                            this.message = "Inquérito alterado";
                            this.type = "success";
                            this.caption = "Inquérito";
                            setTimeout(() => {
                                this.showMessage = false;
                               // this.$router.push("/inquerito_det/" + response.data.master.id_inquerito)
                            }, 5000);
                        },
                        (error) => {
                            this.message = error;
        ...
        startCalendar() {
            const options = {
                ...
                color: "info",
                allowInput: true,
                startDate: this.inquerito.dt_inquerito,
    ...
    created() {
        this.inquerito.id_inquerito = this.$route.params.id;
    },
    mounted() {
    ...
    watch: {
        ...
        "area"(value) {
            if (this.inquerito.id_area > 0) {
                this.setFantArea(parseInt(this.inquerito.id_area));
                this.getQuarteirao(this.inquerito.id_area);
            }
        },
        ...
        "quarteirao"(value) {
            if (this.inquerito.id_quarteirao > 0) {
                this.setFantQuart(parseInt(this.inquerito.id_quarteirao));
            }
        },
    },
