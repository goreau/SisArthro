            ...
            <div class="content">
              ...
              <div class="columns">
                <div class="field column is-3">
                  ...
                  <div class="control">
                    <CmbAuxiliares :tipo="1" @selValue="captura.zona = $event"
                ...
                <div class="field column is-4">
                  ...
                  <div class="control">
                    <CmbMunicipio :id_prop="currentUser.id" @selMun="captura.id_municipio = $event"
                ...
                <div class="field column is-3">
                  ...
                  <div class="control">
                    <CmbLocalidade :id_mun="captura.id_municipio" @selLoc="captura.cod_loc = $event" />
                  </div>
                </div>
              ...
              <div class="columns">
                <div class="field column is-4">
                  ...
                  <div class="control">
                    <CmbAuxiliares :tipo="2" @selValue="captura.agravo = $event"
                ...
                <div class="field column is-3 is-offset-1">
                  ...
                  <div class="control">
                    <CmbAuxiliares :tipo="3" @selValue="captura.atividade = $event"
        ...
        capturaService.create(this.captura).then(
          (response) => {
            ...
            setTimeout(() => {
              ...
              this.$router.push("/captura_det/" + response.data.master.id_captura)
            }, 10000);
          },
          (error) => {
            this.message = error;
