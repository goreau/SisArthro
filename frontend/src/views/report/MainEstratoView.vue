            ...
            <div class="column is-three-fifths">
                ...
                <div class="card">
                    <header class="card-header">
                        <p class="card-header-title is-centered">Estratos</p>
                    </header>
                    <div class="card-content">
                        <div class="content">
                            <section class="section">
                                <div class="field column is-10 dvTipo">
                                    <label class="label">Tipo de Estrato:</label>
                                    <div class="control has-icons-left has-icons-right">
                                        <div class="columns">
                                            <div class="column is-4 linha">
                                                <label class="radio">
                                                    <input type="radio" name="execucao" value="102"
                                                        v-model="tipo_relat" />
                                                    1 - Identificações
                                                </label>
                                            </div>
                                            <div class="column is-4 linha">
                                                <label class="radio">
                                                    <input type="radio" name="execucao" value="107"
                                                        v-model="tipo_relat" />
                                                    2 - Notificação de Cães </label>
                                            </div>
                                            <div class="column is-4 linha">
                                                <label class="radio">
                                                    <input type="radio" name="execucao" value="101"
                                                        v-model="tipo_relat" />
                                                    3 - Capturas
                                                </label>
                                            </div>
...
export default {
    data() {
        return {
            ...
            noAgravo: new Array('101', '102'),
            noSexo: new Array('101', '102'),
        };
    },
    computed: {
        currentUser() {
