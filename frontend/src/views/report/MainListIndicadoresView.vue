            ...
            <div class="column is-four-fifths">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="message">
                            <div class="message-header tipo" style="cursor: pointer" @click="tipoAberto = !tipoAberto">
                                <span>Tipo de Indicador</span>
                                <span class="icon">
                                    <i :class="tipoAberto ? 'fas fa-angle-up' : 'fas fa-angle-down'"></i>
                                </span>
                            </div>
                            <div class="dvTipo" v-show="tipoAberto">
                                <div class="tile is-ancestor">
                                    ...
                                    <div class="tile is-parent is-6">
                                        <div class="tile is-child box">
                                            <h2 class="title is-6 has-text-centered">Indicadores de Vetor e Ambiente
                                            </h2>
                                            <ul>
                        ...
                        <div class="message" v-if="tipo_indic > 0">
                            <div class="message-header" style="cursor: pointer" @click="filtroAberto = !filtroAberto">
                                <span>Filtros</span>
                                <span class="icon">
                                    <i :class="filtroAberto ? 'fas fa-angle-up' : 'fas fa-angle-down'"></i>
                                </span>
                            </div>
                            <div class="dvTipo" v-show="filtroAberto">
                        ...
                        <section v-show="hasData">
                            <div class="dvTipo">
                                <h3 class="title is-6 has-text-centered">{{ indic.titulo }}</h3>
                                <div class="column is-narrow">
                                    <div class="long-division">
                                        <div class="quotient">Numerador: {{ indic.quocient }}</div>
                                        <div class="dividend">Denominador: {{ indic.divisor }}</div>
                                    </div>
                                </div>
                                <Loader v-if="isLoading" />
                                <span class="filter">{{ strFiltro }}</span>
                                <MyTable :loggedUser="{ id: 0, tipo: 0 }" :data="dataTable" :columns="columns"
                                    :pagination="true" :buttons="[]" :has-exports="true" :calc-height="false"
...
export default {
    ...
    data() {
        return {
            ...
            dataTable: [],
            columns: [
                { headerName: "Município", field: "nome" },
                { headerName: "Ano", field: "ano" },
                { headerName: "Registros", field: "qt" },
                { headerName: "Numerador", field: "numerador" },
                { headerName: "Denominador", field: "denominador" },
                { headerName: "Indicador", field: "percentual" },
            ],
    ...
    methods: {
        geraIndic() {
            const opcoesIndic = [
                ...
                },
                {
                    ...
                    divisor: 'Nº cães soropositivos em dois testes para LVC na área prioritária',
                    numerator: 0,
                    denominator: 0,
                    indic: 0
                },
        ...
        processar() {
            ...
            reportService.getListIndic(this.tipo_indic, filt)
                .then((response) => {
