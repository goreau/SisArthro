...
export function gerarPDF(data) {
  ...
  const columns = [
    { header: "Ciclo", dataKey: "ciclo", width: 7 },
    { header: "Codend", dataKey: "codend", width: 30 },
    { header: "Endereço", dataKey: "endereco", width: 60 },
    { header: "Sit", dataKey: "situacao", width: 9 },
    { header: "Tipo", dataKey: "tipo", width: 9 },
    { header: "Veget", dataKey: "vegetacao", width: 12 },
    { header: "Mat Org", dataKey: "mat_org", width: 12 },
    { header: "Galinha", dataKey: "galinha", width: 16 },
    { header: "Cão", dataKey: "cao", width: 16 },
    { header: "Porco", dataKey: "porco", width: 16 },
    { header: "Cavalo", dataKey: "cavalo", width: 16 },
    { header: "Coelho", dataKey: "coelho", width: 16 },
    { header: "Quant", dataKey: "codend", width: 15 },
    { header: "Posit", dataKey: "positivos", width: 15 },
    { header: "Ano Detec", dataKey: "ano", width: 20 },
  ];
  ...
  for (const linha of data) {
    if (cont++ == 24) {
      ...
      doc.autoTable({
        head: [
          [
            { content: "Imóvel", colSpan: 5, styles: { halign: 'center',  } }, 
            { content: "Presença", colSpan: 2, styles: { halign: 'center',  } }, 
            { content: "Animais", colSpan: 5, styles: { halign: 'center',  } },
            { content: "Cães", colSpan: 3, styles: { halign: 'center', } } 
          ],
          columns.map(col => col.header)
        ],
        body: rows.map(row => Object.values(row)),
        columnStyles: {
          0: { textRotation: 90, halign: 'center', valign: 'middle', cellWidth: columns[0].width }, 
          1: { cellWidth: columns[1].width }, 
          2: { cellWidth: columns[2].width }, 
          3: { textRotation: 90, halign: 'center', valign: 'middle', cellWidth: columns[3].width }, 
    ...
    var row = {
        ciclo: linha.ciclo.toString(),
        codend: linha.codend,
        endereco: linha.endereco.trim(),
        situacao: linha.situacao,
        tipo: linha.tipo_imovel.toString(),
        vegetacao: ' ',
        mat_org: ' ',
        galinha:' ',
        cao: '',
...
function addHeader(doc, cabeca){
  ...
  let texto = 'BOLETIM PARA A AVALIAÇÃO DAS CARACTERÍSTICAS AMBIENTAIS DOS IMÓVEIS ';
