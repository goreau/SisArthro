...
export function gerarPDF(data) {
  ...
  const columns = [
    ...
    { header: "Telefone", dataKey: "telefone", width: 12 },
    { header: "Nome", dataKey: "animal", width: 20 },
    { header: "Espécie", dataKey: "especie", width: 10 },
    { header: "RA", dataKey: "ra", width: 10 },
    { header: "Ano Nasc", dataKey: "nasc", width: 10 },
    { header: "Sexo", dataKey: "sexo", width: 10 },
    { header: "Raça", dataKey: "raca", width: 10 },
    { header: "Cor", dataKey: "cor", width: 10 },
      ...
      doc.autoTable({
        head: [
          [
            ...
            { content: "Proprietário", colSpan: 2, styles: { halign: 'center',  } }, 
            { content: "Cão", colSpan: 8, styles: { halign: 'center',  } },
          ],
...
function addHeader(doc, cabeca){
  ...
  let texto = 'BOLETIM DE CADASTRO DE POPULAÇÃO DE CÃES E GATOS  DOMICILIADOS';
