            ...
            <div class="column is-11">
                <div class="card">
                    <header class="card-header">
                        <p class="card-header-title is-centered">Hábitos Alimentares Cadastrados</p>
...
export default {
    ...
    methods: {
        newCapt() {
            this.$router.push("/alimentar/0");
        },
        onEditRow(id) {
            this.$router.push(`/alimentar/${id}`);
        },
