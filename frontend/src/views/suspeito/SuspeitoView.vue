                        ...
                        <div class="content">
                            ...
                            <div class="columns">
                                ...
                                <div class="field column is-4">
                                    ...
                                    <div class="control">
                                        <CmbMunicipio :id_prop="currentUser.id" @selMun="suspeito.id_municipio = $event"
                            ...
                            <div class="columns">
                                <div class="field column is-3">
                                    ...
                                    <div class="control">
                                        <CmbAuxiliares :tipo="1" @selValue="suspeito.id_ambiente = $event"
                                ...
                                <div class="field column is-3">
                                    ...
                                    <div class="control">
                                        <CmbLocalidade :id_mun="suspeito.id_municipio"
    ...
    methods: {
        ...
        create() {
            ...
            if (!this.v$.$error) {
                ...
                suspeitoService.create(this.suspeito).then(
                    (response) => {
                        this.showMessage = true;
                        this.message = "Notificação inserida com numero: " + response.data.master.codigo;
                        this.type = "success";
